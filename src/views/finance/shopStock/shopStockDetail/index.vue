    ...
    <van-form @submit="onSubmit" :rules="rulesRef" required="auto">
        <van-cell-group>
            ...
            <van-field v-model="formInfo.shopCode" name="shopCode" :label="label.shopCode + '：'" :maxlength="255"
                :readonly="true" />
            <van-field v-model="formInfo.costAmount" name="costAmount" :label="label.costAmount + '：'"
                :placeholder="'请输入' + label.costAmount" :rules="rulesRef.costAmount" :maxlength="10" />
            ...
            <van-field v-model="categoryName" name="category" :label="label.category + '：'"
                :placeholder="'请输入' + label.category" :rules="rulesRef.category" @click="choose('category')" readonly />
            <van-field v-model="purchasePlaceName" name="purchasePlace" :label="label.purchasePlace + '：'"
                :placeholder="'请输入' + label.purchasePlace" :rules="rulesRef.purchasePlace" @click="choose('purchasePlace')"
                readonly />
