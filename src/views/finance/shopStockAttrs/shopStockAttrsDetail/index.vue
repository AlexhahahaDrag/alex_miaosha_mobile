<template>
    ...
    <van-form @submit="onSubmit" :rules="rulesRef" required="auto">
        <van-cell-group>
            <van-field v-model="formInfo.stockId" name="stockId" :label="label.stockId + '：'"
                :placeholder="'请输入' + label.stockId" :rules="rulesRef.stockId" :maxlength="19" />
            <van-field v-model="formInfo.attrCode" name="attrCode" :label="label.attrCode + '：'"
                :placeholder="'请输入' + label.attrCode" :rules="rulesRef.attrCode" :maxlength="255" />
            <van-field v-model="formInfo.attrName" name="attrName" :label="label.attrName + '：'"
                :placeholder="'请输入' + label.attrName" :rules="rulesRef.attrName" :maxlength="255" />
            <van-field v-model="formInfo.attrValue" name="attrValue" :label="label.attrValue + '：'"
                :placeholder="'请输入' + label.attrValue" :rules="rulesRef.attrValue" :maxlength="255" />
