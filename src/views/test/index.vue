<template>
  <div class="consumption-card-page">
    ...
    <div class="action-buttons">
      <van-button class="consume-button" @click="handleConsume">消费</van-button>
      <van-button class="recharge-button" @click="handleRecharge">充值</van-button>
    </div>
    ...
    <div class="record-list">
      <div class="record-item" v-for="(record, index) in consumptionRecords" :key="index">
