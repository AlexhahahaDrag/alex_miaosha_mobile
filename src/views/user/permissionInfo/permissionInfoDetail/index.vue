    ...
    <van-form @submit="onSubmit" :rules="rulesRef" required="auto">
        <van-cell-group>
            <van-field v-model="formInfo.permissionCode" name="permissionCode" :label="label.permissionCode + '：'"
                :placeholder="'请输入' + label.permissionCode" :rules="rulesRef.permissionCode" :maxlength="128" />
            <van-field v-model="formInfo.permissionName" name="permissionName" :label="label.permissionName + '：'"
                :placeholder="'请输入' + label.permissionName" :rules="rulesRef.permissionName" :maxlength="128" />
            ...
            <van-field v-model="formInfo.options" name="options" :label="label.options + '：'"
                :placeholder="'请输入' + label.options" :rules="rulesRef.options" :maxlength="65535" />
