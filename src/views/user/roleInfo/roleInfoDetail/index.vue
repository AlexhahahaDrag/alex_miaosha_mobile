<template>
    ...
    <van-form @submit="onSubmit" :rules="rulesRef" required="auto">
        <van-cell-group>
            <van-field v-model="formInfo.roleCode" name="roleCode" :label="label.roleCode + '：'"
                :placeholder="'请输入' + label.roleCode" :rules="rulesRef.roleCode" :maxlength="128" />
            <van-field v-model="formInfo.roleName" name="roleName" :label="label.roleName + '：'"
                :placeholder="'请输入' + label.roleName" :rules="rulesRef.roleName" :maxlength="128" />
